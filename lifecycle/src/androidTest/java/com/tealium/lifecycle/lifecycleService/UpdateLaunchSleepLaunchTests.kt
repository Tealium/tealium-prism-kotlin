...
class UpdateLaunchSleepLaunchTests : LifecycleServiceBaseTests() {
    ...
    fun daysSinceUpdate_isCorrect() {
        assertEquals(2, lifecycleEventState.getInt(StateKey.LIFECYCLE_DAYSSINCEUPDATE))
        assertEquals(3, customEventState.getInt(StateKey.LIFECYCLE_DAYSSINCEUPDATE))
    }
