...
class FirstLaunchTests : LifecycleServiceBaseTests() {
    private val customEventTimestamp: Long
    ...
    @Test
    fun firstLaunchDateMmddyyyy_IsCorrect() {
    ...
    fun totalSecondsAwake_isCorrect() {
        assertEquals(0, lifecycleEventState.getInt(StateKey.LIFECYCLE_TOTALSECONDSAWAKE))
    ...
    @Test
    fun lifecycleEventType_isCorrect() {
