...
class LaunchSleepTests : LifecycleServiceBaseTests() {
    ...
    override fun setUp() {
        ...
        lifecycleEventState = lifecycleService.registerSleep(sleepTimestamp)
    ...
    fun dayOfWeekLocal_isCorrectInt() {
        calendar.time = Date(sleepTimestamp)
    ...
    fun daysSinceLaunch_isCorrect() {
        assertEquals(1, lifecycleEventState.getInt(StateKey.LIFECYCLE_DAYSSINCEFIRSTLAUNCH))
        assertEquals(2, customEventState.getInt(StateKey.LIFECYCLE_DAYSSINCEFIRSTLAUNCH))
    }
    ...
    fun daysSinceLastWake_isCorrect() {
        assertEquals(1, lifecycleEventState.getInt(StateKey.LIFECYCLE_DAYSSINCELASTWAKE))
        assertEquals(2, customEventState.getInt(StateKey.LIFECYCLE_DAYSSINCELASTWAKE))
    }
    ...
    fun secondsAwake_isCorrect() {
        ...
        assertEquals(secondsPerDay, customEventState.getLong(StateKey.LIFECYCLE_SECONDSAWAKE))
    }
    ...
    fun totalSecondsAwake_isCorrect() {
        ...
        assertEquals(secondsPerDay, customEventState.getLong(StateKey.LIFECYCLE_TOTALSECONDSAWAKE))
    }
