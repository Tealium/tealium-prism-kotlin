...
object StateKey {
    ...
    const val LIFECYCLE_DIDDETECT_CRASH = "lifecycle_diddetectcrash"
    const val LIFECYCLE_DAYOFWEEK_LOCAL = "lifecycle_dayofweek_local"
    const val LIFECYCLE_DAYSSINCEFIRSTLAUNCH = "lifecycle_dayssincelaunch"
...
object LifecycleDefault {
    const val FORMAT_ISO_8601 = "yyyy-MM-dd'T'HH:mm:ss'Z'";
    const val INFINITE_SESSION = -1
}

object LifecycleStorageKey {
