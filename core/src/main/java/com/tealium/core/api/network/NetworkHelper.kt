...
interface NetworkHelper {
     ...
     * @param etag Optional etag of the currently known resource
     */
    fun get(url: URL, etag: String?, completion: (NetworkResult) -> Unit) : Disposable
     ...
     * @param payload The body to be POSTed
     */
    fun post(url: URL, payload: TealiumBundle?, completion: (NetworkResult) -> Unit): Disposable
     ...
     * @param etag Optional etag of the currently known resource
     */
    fun getJson(url: URL, etag: String?, completion: (JSONObject?) -> Unit): Disposable
     ...
     * @param etag Optional etag of the currently known resource
     */
    fun getTealiumBundle(url: URL, etag: String?, completion: (TealiumBundle?) -> Unit): Disposable
}