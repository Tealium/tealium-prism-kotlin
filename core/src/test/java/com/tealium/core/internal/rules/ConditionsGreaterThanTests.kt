...
class ConditionsGreaterThanTests {
    ...
    @Test
    fun greaterThan_Matches_Number_String_When_Target_Is_Smaller() {
        val condition = Condition.isGreaterThan(
            orEqual = false,
    ...
    @Test
    fun greaterThan_Does_Not_Match_Number_String_When_Numbers_Are_Equal() {
        val condition = Condition.isGreaterThan(
            orEqual = false,
            variable = "numberstring",
            number = "45"
    ...
    @Test
    fun greaterThan_Does_Not_Match_Number_String_When_Target_Is_Greater() {
        val condition = Condition.isGreaterThan(
            orEqual = false,
            variable = "numberstring",
            number = "50"
    ...
    @Test
    fun greaterThan_Throws_When_DataItem_Is_Boolean() {
        val condition = Condition.isGreaterThan(
            orEqual = false,
            variable = "bool",
            number = "true"
    ...
    @Test
    fun greaterThan_Throws_When_DataItem_Is_DataArray() {
        val condition = Condition.isGreaterThan(
            orEqual = false,
            variable = "list",
            number = "10"
    ...
    @Test
    fun greaterThan_Throws_When_DataItem_Is_DataObject() {
        val condition = Condition.isGreaterThan(
            orEqual = false,
            variable = "object",
            number = "10"
    ...
    @Test
    fun greaterThan_Throws_When_DataItem_Is_Null() {
        val condition = Condition.isGreaterThan(
            orEqual = false,
            variable = "null",
            number = "10"
    ...
    @Test
    fun greaterThan_Matches_Infinity() {
        val condition = Condition.isGreaterThan(
            orEqual = false,
            variable = "infinity",
            number = "10"
    ...
    @Test
    fun greaterThan_Does_Not_Match_Infinity_Equality() {
        val condition = Condition.isGreaterThan(
            orEqual = false,
            variable = "infinity",
            number = "Infinity"
    ...
    @Test
    fun greaterThan_Does_Not_Match_Negative_Infinity() {
        val condition = Condition.isGreaterThan(
            orEqual = false,
    ...
    @Test
    fun greaterThan_Does_Not_Match_Negative_Infinity_Equality() {
        val condition = Condition.isGreaterThan(
            orEqual = false,
            variable = "negativeinfinity",
            number = "-Infinity"
    ...
    @Test
    fun greaterThan_Does_Not_Match_When_DataItem_Is_NaN() {
        val condition = Condition.isGreaterThan(
            orEqual = false,
            variable = "nan",
            number = "0"
    ...
    @Test
    fun greaterThan_Does_Not_Match_When_Filter_Is_NaN() {
        val condition = Condition.isGreaterThan(
            orEqual = false,
            variable = "infinity",
            number = "NaN"
    ...
    @Test
    fun greaterThan_Does_Not_Match_When_Two_NaNs() {
        val condition = Condition.isGreaterThan(
            orEqual = false,
            variable = "nan",
            number = "NaN"
    ...
    @Test
    fun greaterThan_Throws_When_DataItem_Is_Empty_String() {
        val condition = Condition.isGreaterThan(
            orEqual = false,
    ...
    @Test
    fun greaterThan_Throws_When_Filter_Is_Empty_String() {
        val condition = Condition.isGreaterThan(
            orEqual = false,
            variable = "infinity",
            number = ""
